...
import { papersAPI, categoriesAPI, uploadAPI } from '@/lib/api';
...
const paperTypes = [
  { value: 'methodology_history', label: 'Usul/Tarih' },
  { value: 'social_sciences', label: 'Sosyal Bilimler' },
  { value: 'criticism', label: 'Tenkit İçerikli' },
];
...
export default function CreatePaper() {
  ...
  const handleSubmit = async (status: string) => {
    ...
    try {
      ...
      await papersAPI.create(submitData);
      showSuccess(
        status === 'published' ? 'Bildiri Yayınlandı!' : 'Bildiri Kaydedildi!',
        status === 'published' ? 'Bildiri başarıyla yayınlandı.' : 'Bildiri taslak olarak kaydedildi.',
      ...
      showError(
        'Hata Oluştu',
        'Bildiri kaydedilirken hata oluştu: ' + (error.response?.data?.message || 'Bilinmeyen hata')
      );
    } finally {
      setLoading(false);
      setUploading(false);
          ...
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-gray-700">
                Yeni bir bildiri ekleyin ve yayınlayın.
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <FileUpload
                    ...
                    maxSize={50}
                    label="PDF Dosyası"
                    description="Bildirinin PDF dosyasını yükleyin"
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                    placeholder="bildiri, konferans, araştırma..."
                  />
                </div>
