...
import { creativeWorksAPI, categoriesAPI, uploadAPI } from '@/lib/api';
...
export default function CreatePresentation() {
  ...
  const handleInputChange = (field: keyof PresentationFormData, value: any) => {
    setFormData(prev => ({
      ...prev,
      [field]: value,
    }));
  ...
  const handleSubmit = async (status: string) => {
    ...
    try {
      ...
      alert(status === 'published' ? 'Sunum yayınlandı!' : 'Sunum kaydedildi!');
      router.push('/admin/presentations');
    } catch (error: any) {
      console.error('Error saving presentation:', error);
      alert('Sunum kaydedilirken hata oluştu: ' + (error.response?.data?.message || 'Bilinmeyen hata'));
    } finally {
      setLoading(false);
      setUploading(false);
    }
          ...
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-gray-700">
                Yeni bir sunum ekleyin ve yayınlayın.
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                    placeholder="Akademisyenler, öğrenciler, genel..."
                  />
                </div>
                ...
                <div className="space-y-4">
                  <div>
                    <FileUpload
                      ...
                      maxSize={50}
                      label="PDF Dosyası"
                      description="Sunumun PDF dosyasını yükleyin"
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                    placeholder="sunum, konferans, eğitim..."
                  />
                </div>
